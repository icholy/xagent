...
var file_xagent_v1_xagent_proto_depIdxs = []int32{
	...
	45,  // 21: xagent.v1.GetTaskDetailsResponse.events:type_name -> xagent.v1.Event
	...
	38,  // 31: xagent.v1.FindLinksByURLResponse.links:type_name -> xagent.v1.TaskLink
	114, // 32: xagent.v1.Event.created_at:type_name -> google.protobuf.Timestamp
	45,  // 33: xagent.v1.ListEventsResponse.events:type_name -> xagent.v1.Event
	45,  // 34: xagent.v1.CreateEventResponse.event:type_name -> xagent.v1.Event
	45,  // 35: xagent.v1.GetEventResponse.event:type_name -> xagent.v1.Event
	45,  // 36: xagent.v1.ListEventsByTaskResponse.events:type_name -> xagent.v1.Event
	62,  // 37: xagent.v1.SubmitRunnerEventsRequest.events:type_name -> xagent.v1.RunnerEvent
	114, // 38: xagent.v1.RegisteredWorkspace.updated_at:type_name -> google.protobuf.Timestamp
	65,  // 39: xagent.v1.RegisterWorkspacesRequest.workspaces:type_name -> xagent.v1.RegisteredWorkspace
	65,  // 40: xagent.v1.ListWorkspacesResponse.workspaces:type_name -> xagent.v1.RegisteredWorkspace
	114, // 41: xagent.v1.Key.expires_at:type_name -> google.protobuf.Timestamp
	114, // 42: xagent.v1.Key.created_at:type_name -> google.protobuf.Timestamp
	114, // 43: xagent.v1.CreateKeyRequest.expires_at:type_name -> google.protobuf.Timestamp
	72,  // 44: xagent.v1.CreateKeyResponse.key:type_name -> xagent.v1.Key
	72,  // 45: xagent.v1.ListKeysResponse.keys:type_name -> xagent.v1.Key
	114, // 46: xagent.v1.GitHubAccount.created_at:type_name -> google.protobuf.Timestamp
	114, // 47: xagent.v1.AtlassianAccount.created_at:type_name -> google.protobuf.Timestamp
	114, // 48: xagent.v1.Org.created_at:type_name -> google.protobuf.Timestamp
	114, // 49: xagent.v1.Org.updated_at:type_name -> google.protobuf.Timestamp
	114, // 50: xagent.v1.OrgMember.created_at:type_name -> google.protobuf.Timestamp
	87,  // 51: xagent.v1.CreateOrgResponse.org:type_name -> xagent.v1.Org
	87,  // 52: xagent.v1.ListOrgsResponse.orgs:type_name -> xagent.v1.Org
	88,  // 53: xagent.v1.AddOrgMemberResponse.member:type_name -> xagent.v1.OrgMember
	88,  // 54: xagent.v1.ListOrgMembersResponse.members:type_name -> xagent.v1.OrgMember
	106, // 55: xagent.v1.RoutingRule.create:type_name -> xagent.v1.CreateTaskAction
	115, // 56: xagent.v1.CreateTaskAction.archive_after:type_name -> google.protobuf.Duration
	105, // 57: xagent.v1.GetRoutingRulesResponse.rules:type_name -> xagent.v1.RoutingRule
	105, // 58: xagent.v1.SetRoutingRulesRequest.rules:type_name -> xagent.v1.RoutingRule
	105, // 59: xagent.v1.SetRoutingRulesResponse.rules:type_name -> xagent.v1.RoutingRule
	114, // 60: xagent.v1.CreateGitHubTokenResponse.expires_at:type_name -> google.protobuf.Timestamp
	...
	43,  // 78: xagent.v1.XAgentService.FindLinksByURL:input_type -> xagent.v1.FindLinksByURLRequest
	46,  // 79: xagent.v1.XAgentService.ListEvents:input_type -> xagent.v1.ListEventsRequest
	48,  // 80: xagent.v1.XAgentService.CreateEvent:input_type -> xagent.v1.CreateEventRequest
	50,  // 81: xagent.v1.XAgentService.GetEvent:input_type -> xagent.v1.GetEventRequest
	52,  // 82: xagent.v1.XAgentService.DeleteEvent:input_type -> xagent.v1.DeleteEventRequest
	54,  // 83: xagent.v1.XAgentService.AddEventTask:input_type -> xagent.v1.AddEventTaskRequest
	56,  // 84: xagent.v1.XAgentService.RemoveEventTask:input_type -> xagent.v1.RemoveEventTaskRequest
	58,  // 85: xagent.v1.XAgentService.ListEventTasks:input_type -> xagent.v1.ListEventTasksRequest
	60,  // 86: xagent.v1.XAgentService.ListEventsByTask:input_type -> xagent.v1.ListEventsByTaskRequest
	63,  // 87: xagent.v1.XAgentService.SubmitRunnerEvents:input_type -> xagent.v1.SubmitRunnerEventsRequest
	66,  // 88: xagent.v1.XAgentService.RegisterWorkspaces:input_type -> xagent.v1.RegisterWorkspacesRequest
	68,  // 89: xagent.v1.XAgentService.ListWorkspaces:input_type -> xagent.v1.ListWorkspacesRequest
	70,  // 90: xagent.v1.XAgentService.ClearWorkspaces:input_type -> xagent.v1.ClearWorkspacesRequest
	73,  // 91: xagent.v1.XAgentService.CreateKey:input_type -> xagent.v1.CreateKeyRequest
	75,  // 92: xagent.v1.XAgentService.ListKeys:input_type -> xagent.v1.ListKeysRequest
	77,  // 93: xagent.v1.XAgentService.DeleteKey:input_type -> xagent.v1.DeleteKeyRequest
	80,  // 94: xagent.v1.XAgentService.UnlinkGitHubAccount:input_type -> xagent.v1.UnlinkGitHubAccountRequest
	82,  // 95: xagent.v1.XAgentService.LinkGitHubInstallation:input_type -> xagent.v1.LinkGitHubInstallationRequest
	85,  // 96: xagent.v1.XAgentService.UnlinkAtlassianAccount:input_type -> xagent.v1.UnlinkAtlassianAccountRequest
	89,  // 97: xagent.v1.XAgentService.CreateOrg:input_type -> xagent.v1.CreateOrgRequest
	91,  // 98: xagent.v1.XAgentService.ListOrgs:input_type -> xagent.v1.ListOrgsRequest
	93,  // 99: xagent.v1.XAgentService.DeleteOrg:input_type -> xagent.v1.DeleteOrgRequest
	95,  // 100: xagent.v1.XAgentService.AddOrgMember:input_type -> xagent.v1.AddOrgMemberRequest
	97,  // 101: xagent.v1.XAgentService.RemoveOrgMember:input_type -> xagent.v1.RemoveOrgMemberRequest
	99,  // 102: xagent.v1.XAgentService.ListOrgMembers:input_type -> xagent.v1.ListOrgMembersRequest
	101, // 103: xagent.v1.XAgentService.GetOrgSettings:input_type -> xagent.v1.GetOrgSettingsRequest
	103, // 104: xagent.v1.XAgentService.GenerateAtlassianWebhookSecret:input_type -> xagent.v1.GenerateAtlassianWebhookSecretRequest
	107, // 105: xagent.v1.XAgentService.GetRoutingRules:input_type -> xagent.v1.GetRoutingRulesRequest
	109, // 106: xagent.v1.XAgentService.SetRoutingRules:input_type -> xagent.v1.SetRoutingRulesRequest
	111, // 107: xagent.v1.XAgentService.CreateGitHubToken:input_type -> xagent.v1.CreateGitHubTokenRequest
	3,   // 108: xagent.v1.XAgentService.Ping:output_type -> xagent.v1.PingResponse
	10,  // 109: xagent.v1.XAgentService.GetProfile:output_type -> xagent.v1.GetProfileResponse
	12,  // 110: xagent.v1.XAgentService.ListTasks:output_type -> xagent.v1.ListTasksResponse
	14,  // 111: xagent.v1.XAgentService.ListRunnerTasks:output_type -> xagent.v1.ListRunnerTasksResponse
	16,  // 112: xagent.v1.XAgentService.ListChildTasks:output_type -> xagent.v1.ListChildTasksResponse
	18,  // 113: xagent.v1.XAgentService.CreateTask:output_type -> xagent.v1.CreateTaskResponse
	20,  // 114: xagent.v1.XAgentService.GetTask:output_type -> xagent.v1.GetTaskResponse
	22,  // 115: xagent.v1.XAgentService.GetTaskDetails:output_type -> xagent.v1.GetTaskDetailsResponse
	24,  // 116: xagent.v1.XAgentService.UpdateTask:output_type -> xagent.v1.UpdateTaskResponse
	26,  // 117: xagent.v1.XAgentService.ArchiveTask:output_type -> xagent.v1.ArchiveTaskResponse
	28,  // 118: xagent.v1.XAgentService.UnarchiveTask:output_type -> xagent.v1.UnarchiveTaskResponse
	30,  // 119: xagent.v1.XAgentService.CancelTask:output_type -> xagent.v1.CancelTaskResponse
	32,  // 120: xagent.v1.XAgentService.RestartTask:output_type -> xagent.v1.RestartTaskResponse
	35,  // 121: xagent.v1.XAgentService.UploadLogs:output_type -> xagent.v1.UploadLogsResponse
	37,  // 122: xagent.v1.XAgentService.ListLogs:output_type -> xagent.v1.ListLogsResponse
	40,  // 123: xagent.v1.XAgentService.CreateLink:output_type -> xagent.v1.CreateLinkResponse
	42,  // 124: xagent.v1.XAgentService.ListLinks:output_type -> xagent.v1.ListLinksResponse
	44,  // 125: xagent.v1.XAgentService.FindLinksByURL:output_type -> xagent.v1.FindLinksByURLResponse
	47,  // 126: xagent.v1.XAgentService.ListEvents:output_type -> xagent.v1.ListEventsResponse
	49,  // 127: xagent.v1.XAgentService.CreateEvent:output_type -> xagent.v1.CreateEventResponse
	51,  // 128: xagent.v1.XAgentService.GetEvent:output_type -> xagent.v1.GetEventResponse
	53,  // 129: xagent.v1.XAgentService.DeleteEvent:output_type -> xagent.v1.DeleteEventResponse
	55,  // 130: xagent.v1.XAgentService.AddEventTask:output_type -> xagent.v1.AddEventTaskResponse
	57,  // 131: xagent.v1.XAgentService.RemoveEventTask:output_type -> xagent.v1.RemoveEventTaskResponse
	59,  // 132: xagent.v1.XAgentService.ListEventTasks:output_type -> xagent.v1.ListEventTasksResponse
	61,  // 133: xagent.v1.XAgentService.ListEventsByTask:output_type -> xagent.v1.ListEventsByTaskResponse
	64,  // 134: xagent.v1.XAgentService.SubmitRunnerEvents:output_type -> xagent.v1.SubmitRunnerEventsResponse
	67,  // 135: xagent.v1.XAgentService.RegisterWorkspaces:output_type -> xagent.v1.RegisterWorkspacesResponse
	69,  // 136: xagent.v1.XAgentService.ListWorkspaces:output_type -> xagent.v1.ListWorkspacesResponse
	71,  // 137: xagent.v1.XAgentService.ClearWorkspaces:output_type -> xagent.v1.ClearWorkspacesResponse
	74,  // 138: xagent.v1.XAgentService.CreateKey:output_type -> xagent.v1.CreateKeyResponse
	76,  // 139: xagent.v1.XAgentService.ListKeys:output_type -> xagent.v1.ListKeysResponse
	78,  // 140: xagent.v1.XAgentService.DeleteKey:output_type -> xagent.v1.DeleteKeyResponse
	81,  // 141: xagent.v1.XAgentService.UnlinkGitHubAccount:output_type -> xagent.v1.UnlinkGitHubAccountResponse
	83,  // 142: xagent.v1.XAgentService.LinkGitHubInstallation:output_type -> xagent.v1.LinkGitHubInstallationResponse
	86,  // 143: xagent.v1.XAgentService.UnlinkAtlassianAccount:output_type -> xagent.v1.UnlinkAtlassianAccountResponse
	90,  // 144: xagent.v1.XAgentService.CreateOrg:output_type -> xagent.v1.CreateOrgResponse
	92,  // 145: xagent.v1.XAgentService.ListOrgs:output_type -> xagent.v1.ListOrgsResponse
	94,  // 146: xagent.v1.XAgentService.DeleteOrg:output_type -> xagent.v1.DeleteOrgResponse
	96,  // 147: xagent.v1.XAgentService.AddOrgMember:output_type -> xagent.v1.AddOrgMemberResponse
	98,  // 148: xagent.v1.XAgentService.RemoveOrgMember:output_type -> xagent.v1.RemoveOrgMemberResponse
	100, // 149: xagent.v1.XAgentService.ListOrgMembers:output_type -> xagent.v1.ListOrgMembersResponse
	102, // 150: xagent.v1.XAgentService.GetOrgSettings:output_type -> xagent.v1.GetOrgSettingsResponse
	104, // 151: xagent.v1.XAgentService.GenerateAtlassianWebhookSecret:output_type -> xagent.v1.GenerateAtlassianWebhookSecretResponse
	108, // 152: xagent.v1.XAgentService.GetRoutingRules:output_type -> xagent.v1.GetRoutingRulesResponse
	110, // 153: xagent.v1.XAgentService.SetRoutingRules:output_type -> xagent.v1.SetRoutingRulesResponse
	112, // 154: xagent.v1.XAgentService.CreateGitHubToken:output_type -> xagent.v1.CreateGitHubTokenResponse
