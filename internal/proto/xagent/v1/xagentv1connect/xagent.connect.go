...
const (
	...
	// XAgentServiceUnarchiveTaskProcedure is the fully-qualified name of the XAgentService's
	// UnarchiveTask RPC.
	XAgentServiceUnarchiveTaskProcedure = "/xagent.v1.XAgentService/UnarchiveTask"
	...
	// XAgentServiceTestEventProcedure is the fully-qualified name of the XAgentService's TestEvent RPC.
	XAgentServiceTestEventProcedure = "/xagent.v1.XAgentService/TestEvent"
...
func NewXAgentServiceClient(httpClient connect.HTTPClient, baseURL string, opts ...connect.ClientOption) XAgentServiceClient {
	...
	return &xAgentServiceClient{
		...
		getProfile: connect.NewClient[v1.GetProfileRequest, v1.GetProfileResponse](
			...
			connect.WithSchema(xAgentServiceMethods.ByName("GetProfile")),
			connect.WithClientOptions(opts...),
		),
		...
		unarchiveTask: connect.NewClient[v1.UnarchiveTaskRequest, v1.UnarchiveTaskResponse](
			httpClient,
			baseURL+XAgentServiceUnarchiveTaskProcedure,
			connect.WithSchema(xAgentServiceMethods.ByName("UnarchiveTask")),
			connect.WithClientOptions(opts...),
		),
		...
		registerWorkspaces: connect.NewClient[v1.RegisterWorkspacesRequest, v1.RegisterWorkspacesResponse](
			...
			connect.WithSchema(xAgentServiceMethods.ByName("RegisterWorkspaces")),
			connect.WithClientOptions(opts...),
		),
		listWorkspaces: connect.NewClient[v1.ListWorkspacesRequest, v1.ListWorkspacesResponse](
			httpClient,
			baseURL+XAgentServiceListWorkspacesProcedure,
		...
		unlinkAtlassianAccount: connect.NewClient[v1.UnlinkAtlassianAccountRequest, v1.UnlinkAtlassianAccountResponse](
			...
			connect.WithSchema(xAgentServiceMethods.ByName("UnlinkAtlassianAccount")),
			connect.WithClientOptions(opts...),
		),
		...
		testEvent: connect.NewClient[v1.TestEventRequest, v1.TestEventResponse](
			httpClient,
			baseURL+XAgentServiceTestEventProcedure,
			connect.WithSchema(xAgentServiceMethods.ByName("TestEvent")),
			connect.WithClientOptions(opts...),
		),
...
func (c *xAgentServiceClient) GetProfile(ctx context.Context, req *v1.GetProfileRequest) (*v1.GetProfileResponse, error) {
...
// UnarchiveTask calls xagent.v1.XAgentService.UnarchiveTask.
func (c *xAgentServiceClient) UnarchiveTask(ctx context.Context, req *v1.UnarchiveTaskRequest) (*v1.UnarchiveTaskResponse, error) {
...
// ListWorkspaces calls xagent.v1.XAgentService.ListWorkspaces.
func (c *xAgentServiceClient) ListWorkspaces(ctx context.Context, req *v1.ListWorkspacesRequest) (*v1.ListWorkspacesResponse, error) {
...
// TestEvent calls xagent.v1.XAgentService.TestEvent.
func (c *xAgentServiceClient) TestEvent(ctx context.Context, req *v1.TestEventRequest) (*v1.TestEventResponse, error) {
...
func NewXAgentServiceHandler(svc XAgentServiceHandler, opts ...connect.HandlerOption) (string, http.Handler) {
	...
	xAgentServiceUnarchiveTaskHandler := connect.NewUnaryHandlerSimple(
		XAgentServiceUnarchiveTaskProcedure,
		svc.UnarchiveTask,
		connect.WithSchema(xAgentServiceMethods.ByName("UnarchiveTask")),
		connect.WithHandlerOptions(opts...),
	)
	...
	xAgentServiceListExternalEventsHandler := connect.NewUnaryHandlerSimple(
	...
	xAgentServiceListWorkspacesHandler := connect.NewUnaryHandlerSimple(
		XAgentServiceListWorkspacesProcedure,
		svc.ListWorkspaces,
		connect.WithSchema(xAgentServiceMethods.ByName("ListWorkspaces")),
		connect.WithHandlerOptions(opts...),
	)
	...
	xAgentServiceTestEventHandler := connect.NewUnaryHandlerSimple(
		XAgentServiceTestEventProcedure,
		svc.TestEvent,
		connect.WithSchema(xAgentServiceMethods.ByName("TestEvent")),
		connect.WithHandlerOptions(opts...),
	)
	...
	return "/xagent.v1.XAgentService/", http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		...
		case XAgentServiceUnarchiveTaskProcedure:
			xAgentServiceUnarchiveTaskHandler.ServeHTTP(w, r)
		...
		case XAgentServiceTestEventProcedure:
...
func (UnimplementedXAgentServiceHandler) UnarchiveTask(context.Context, *v1.UnarchiveTaskRequest) (*v1.UnarchiveTaskResponse, error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("xagent.v1.XAgentService.UnarchiveTask is not implemented"))
}
...
func (UnimplementedXAgentServiceHandler) RegisterWorkspaces(context.Context, *v1.RegisterWorkspacesRequest) (*v1.RegisterWorkspacesResponse, error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("xagent.v1.XAgentService.RegisterWorkspaces is not implemented"))
}
...
func (UnimplementedXAgentServiceHandler) UnlinkAtlassianAccount(context.Context, *v1.UnlinkAtlassianAccountRequest) (*v1.UnlinkAtlassianAccountResponse, error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("xagent.v1.XAgentService.UnlinkAtlassianAccount is not implemented"))
}
...
func (UnimplementedXAgentServiceHandler) TestEvent(context.Context, *v1.TestEventRequest) (*v1.TestEventResponse, error) {
